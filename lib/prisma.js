...
// Append connection timeouts to handle serverless cold starts and sleeping DBs.
// Free tier Aiven often has limit of ~5 connections, so we limit pool to 3 per lambda to be safe.
const connectionParams = "&connect_timeout=60&pool_timeout=60&socket_timeout=60&connection_limit=3";
